...
│                                                                 │
│  ┌────────────────────────────┐                                 │
│  │  UC-01: Шифровать текст    │◄── Пользователь вводит текст    │
│  │  - Ввести исходный текст   │    и нажимает «Зашифровать»     │
│  │  - Указать сдвиг           │                                 │
│  │  - Получить шифртекст      │                                 │
│  └────────────────────────────┘                                 │
│                                                                 │
│  ┌────────────────────────────┐                                 │
│  │  UC-02: Дешифровать текст  │◄── Пользователь вводит шифр     │
│  │  - Ввести шифртекст        │    и нажимает «Расшифровать»    │
│  │  - Указать сдвиг           │                                 │
│  │  - Получить оригинал       │                                 │
│  └────────────────────────────┘                                 │
│                                                                 │
│  ┌────────────────────────────┐                                 │
│  │  UC-03: Скопировать        │◄── Пользователь нажимает        │
│  │  результат                 │    «Копировать»                 │
│  └────────────────────────────┘                                 │
│                                                                 │
│  ┌────────────────────────────┐                                 │
│  │  UC-04: Очистить поля      │◄── Пользователь нажимает        │
│  └────────────────────────────┘    «Очистить»                  │
│                                                                 │
│  ┌────────────────────────────┐                                 │
│  │  UC-05: Просмотр статуса   │    (автоматически)              │
│  │  операции                  │                                 │
│  └────────────────────────────┘                                 │
│                                                                 │
│  ┌─────────────────────────────────────────────────────────┐   │
│  │  <<include>>: Валидация ввода (пустое поле → ошибка)    │   │
│  └─────────────────────────────────────────────────────────┘   │
│                                                                 │
│  ┌─────────────────────────────────────────────────────────┐   │
│  │  <<extend>>: Обработка исключений (null, ошибки)        │   │
│  └─────────────────────────────────────────────────────────┘   │
└─────────────────────────────────────────────────────────────────┘
         ↑
    👤 Пользователь
